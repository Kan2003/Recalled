...
// panels expect. The mock data in ./data.ts is richer than what we actually
// store (no speakers, no per-line transcript timestamps, no unresolved
// questions, no related-meeting overlap) — those fields are degraded to
// empty/neutral values here rather than invented.
